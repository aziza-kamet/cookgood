...
public class AddCommentServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            if(request.getParameter("uid") != null && request.getParameter("rid") != null && request.getParameter("text") != null ){
                ...
                db.addComment(rid, uid, text);
                request.setAttribute("rid", rid);
                request.getRequestDispatcher("/pages/templates/comments_temp.jsp").include(request, response);
